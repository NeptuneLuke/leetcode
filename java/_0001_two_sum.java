...
public class _0001_two_sum {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> solution = two_sum_1(nums,target);
     ...
     */
    public static ArrayList<Integer> two_sum_1(ArrayList<Integer> nums, int target) {
     ...
     */
    public static ArrayList<Integer> two_sum_2(ArrayList<Integer> nums, int target) {
     ...
     */
    public static ArrayList<Integer> two_sum_3(ArrayList<Integer> nums, int target) {
